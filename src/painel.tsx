  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[268px_1fr]">
      <aside className="sticky top-0 z-30 border-b border-border/70 bg-sidebar/85 px-4 py-3 backdrop-blur-xl lg:flex lg:h-screen lg:flex-col lg:border-r lg:border-b-0 lg:px-6 lg:py-7">
        ...
        <Link
          to="/clientes"
          className="mt-3 flex items-center gap-2.5 rounded-xl border border-border bg-card/60 px-3 py-2.5 text-sm font-medium transition-colors hover:bg-accent/60"
        >
        ...
        <Link
          to="/planos"
          className="mt-2 flex items-center justify-between gap-2 rounded-xl border border-border bg-card/60 px-3 py-2.5 text-xs transition-colors hover:bg-accent/60"
        >
